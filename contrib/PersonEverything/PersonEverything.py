...
import os
import gramps
from gramps.gen.utils.string import gender
try:
    from gramps.gen.utils.string import conf_strings # works for 4.0.4 ?
except:
    from gramps.gen.utils.string import confidence as conf_strings # works for 4.0.0
