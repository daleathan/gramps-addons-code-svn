...
WEBSITES = [
    ...
    ["Person", "Gallica", "Gallica", '''http://gallica.bnf.fr/Search?ArianeWireIndex=index&p=1&lang=FR&q=u"%(surname)s,+%(given)s"'''],
    ...
    ["Person", "FR-Google", _("FR Google"), '''http://www.google.fr/#hl=fr&q=u"%(surname)s,+%(given)s"'''],
