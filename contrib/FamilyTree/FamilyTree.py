...
class FamilyTree(gen.plug.report.Report):
    ...
    def __person_get_display_name(self, person):
        ...
        text = gen.display.name.displayer.display_name(n)
        tags = []
...
class FamilyTreeOptions(gen.plug.report.MenuReportOptions):
    ...
    def add_menu_options(self, menu):
        ...
        kekule_start_number = gen.plug.menu.NumberOption(_("Kekule number of husband"), 0, 0, 16384)
        ...
        include_notes = gen.plug.menu.BooleanOption(_("Include Notes"), True)
        ...
        protect_private = gen.plug.menu.BooleanOption(_("Protect private items"), True)
